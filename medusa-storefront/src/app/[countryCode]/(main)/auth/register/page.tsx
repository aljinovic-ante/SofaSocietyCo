    ...
    <div className="flex min-h-screen">
      ...
      <div className="w-1/2 flex flex-col justify-center px-16">
        <h1 className="text-4xl font-semibold mb-8">
          Welcome to Sofa Society! <br /> Create your account.
        </h1>
        ...
        >
          <div className="flex gap-4">
            <input
              ...
              className="border border-gray-300 rounded-md px-3 py-2 w-1/2 focus:outline-none focus:ring-1 focus:ring-black"
              required
            />
            <input
              name="last_name"
