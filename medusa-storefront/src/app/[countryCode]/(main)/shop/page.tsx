...
export default function ShopPage({
  ...
  searchParams: { page?: string; sortBy?: string; category?: string }
}) {
  const { page, sortBy, category } = searchParams
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6 border-b border-neutral-200 pb-6 mb-10">
          <div className="flex flex-wrap items-center gap-3">
            <select className="border border-neutral-300 rounded-md px-3 py-2 text-sm bg-white">
              <option>Collection</option>
              <option>Modern Luxe</option>
              <option>Boho Chic</option>
              <option>Scandinavian Simplicity</option>
